...
import { validateSpellingConsistency } from './modules/spelling.mjs'
import {
...
export function getAllValidations (docType) {
  ...
  validations.push({
    ...
    tasks: [
      ...
      { key: 'spellingconsistency', title: 'Spelling consistency', task: async (ctx) => validateSpellingConsistency(ctx.doc, ctx.options) },
