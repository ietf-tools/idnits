...
export async function checkNits (raw, filename, {
  ...
  if (doc.type === 'xml') {
    ...
    progressReport('Validating ipr autogenerated boilerplate...')
  ...
  if (doc.type === 'txt') {
    ...
    if (doc.docKind !== 'rfc') {
      progressReport('Validating acceptable paragraph pointing to the list of current I-Ds...')
      result.push(...(await validateParagraphLinkingToIdsList(doc, { mode })))
    }
  }
